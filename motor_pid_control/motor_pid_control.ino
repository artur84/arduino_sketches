...
#define InB1            3                      // INB motor pin
#define PWM1            4                       // PWM motor pin
#define encodPinA1      20                       // encoder A pin
